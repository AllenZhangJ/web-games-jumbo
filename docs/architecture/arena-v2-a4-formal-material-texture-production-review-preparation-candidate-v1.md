...
| 验证 | 测试、类型、构建、治理、纹理解码、GLTF材质、浏览器、设备、真人和性能全部顺延 |
...
源码构造时会拒绝贴图/Binding/Consumer不闭合、1024²身份漂移、path/bytes/SHA漂移、外部URI关系漂移、六角色明暗Pattern缺失、单敌人材质身份漂移、伪造批准以及超出16 MiB候选估算。延期测试已经登记但未运行，不能声明纹理解码、PBR材质、灯光、颜色、设备、内存或生命周期通过。
