...
| 验证 | 测试、类型、构建、治理、GLB、浏览器、设备、真人与性能全部顺延 |
...
源码构造时会拒绝20武器/附件/轮廓族不闭合、收藏顺序漂移、动作或模式读法缺失、挂点/Forward Axis漂移、模型/纹理path/bytes/SHA漂移、伪造批准以及把候选Transform写成已验证。延期测试已经登记但未运行，不能声明武器手持、落地、动作、六角色组合或设备通过。
