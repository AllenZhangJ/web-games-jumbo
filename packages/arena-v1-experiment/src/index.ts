...
export type {
  ...
  ArenaV2WeaponHookObstructionProbeResult,
  ArenaV2WeaponHookObstructionRect,
  ArenaV2WeaponHookObstructionScenario,
} from './arena-v2-weapon-hook-obstruction-prototype.js';
export type {
