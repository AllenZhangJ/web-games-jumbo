...
| 直线压制 | 研究候选 | 4/5 | 正式 Definition | 不晋级 |
| 读招反制 | 研究候选 | 4/5 | 正式 Definition | 不晋级 |
| 绕后 | 研究候选 | 4/5 | 正式 Definition | 不晋级 |
...
这一步关闭了读招反制的正式动作状态、候选 Replay 和研究反馈来源门禁，但没有关闭正式 Definition、最终反馈资产、三人/网络多人、主动转身和真人可读性。
...
这一步关闭了绕后的正式动作状态、候选 Replay 和研究反馈来源门禁，但没有关闭正式 Definition、最终反馈资产、多人遮挡、侧向进入和真人可读性。
...
继续复用单一攻击线原型，补齐正式 Definition 和设备可读性。不能因为它出手快就直接变成生产远程武器。
...
目标主动转身已经进入 Replay；双人边缘反馈来源也已验证。下一步补充侧向进入、多人遮挡和分叉路线观察负担，固定目标朝向探针不能代替这些场景。

## 9. 下一批实现顺序

1. 将读招反制和绕后的边缘 Replay 扩展到侧向进入、多次转身和多人遮挡；攻击/跳跃穿插的基础门禁已通过。
...
本轮已经完成“直线压制、读招反制、绕后的研究动作状态、候选 Replay、双人边缘后果、研究反馈来源和攻击/跳跃基础穿插收敛”，没有完成“六把武器生产化”。三个研究候选现在为 4/5，仅剩正式 Definition；生产基线仍缺候选专属 Replay。下一步继续做侧向进入/多人遮挡、最终表现资产和真人可读性，不扩张角色、按键、界面或收藏系统。
