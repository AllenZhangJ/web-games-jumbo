...
| 验证 | 测试、类型、构建、治理、试听、波形、响度、多人拥塞、浏览器、设备和性能全部顺延 |
...
源码构造时会拒绝20×3不闭合、Cue/Asset重复、path/bytes/SHA漂移、阶段与Manifest不一致、动作情境缺失、Gain/Priority漂移、Owner权威来源漂移和伪造批准。延期测试已经登记但未运行，不能声明试听、阶段区分、混音、恢复、静音、设备或生命周期通过。
