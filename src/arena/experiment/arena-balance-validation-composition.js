...
export const ARENA_STAGE9_BALANCE_VALIDATION_CANDIDATE_ID =
...
export function createArenaStage9BalanceValidationExperimentDefinition(value = {}) {
  ...
  return createArenaBalanceCandidateExperimentDefinition({
    ...
    botGatePolicy: createArenaStage9BalanceBotGatePolicy(
      ARENA_STAGE9_BALANCE_VALIDATION_CASE_COUNT,
    ),
