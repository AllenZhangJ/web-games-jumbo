...
已接受整体边界；阶段 1 已选择项目内轻量街机物理，阶段 2 已落地无渲染 MatchCore，阶段 3 已落地隐藏机器人与本地快速匹配，阶段 4 已落地数据驱动 Rule/Core 装备闭环，阶段 5 已落地独立地图权威时间轴。Stage 6 当前已落地 Character/Input/Replay、Movement Rule/Core、Bot 同权移动、三端 Pointer、程序化灰盒、HUD 与 Session/重赛闭环；Web 运行与 100 局 soak 已通过。S6.6.1～S6.6.3c 已建立版本化盲测合同、确定性分组、采集运行时、双槽持久化、Trial Controller 与独立 Web 采集工作台；S6.6.4 已建立五个 E3 target 的版本化证据合同和附件验证器，但没有真实设备 Record。Stage 7 S7.1 已落地版本化角色表现、资产、动画语义、六方向与失败关闭运行时合同，现有 Q 版人物和发条机器人已作为可替换程序化占位 Provider 迁入；正式 GLB、动画与附件尚未开始。Stage 8 S8.1 已落地 PlayerProfile、迁移与 A/B 本地存档骨架，S8.2 已落地无 UI 产品状态机、角色选择保存、单 Match 所有权和 QuickMatch 闭环，S8.3 已落地奖励/解锁 Rule→Core、唯一 Profile 写入者与 reward/unlock 生命周期，S8.4 已落地双方共享冻结内容、Replay V5 与快捷重赛，S8.5.1～S8.5.3 已落地产品 ViewModel/Intent、非拥有 Match 表现桥、自动奖励/重试 Flow 和统一产品表现 Session；三端正式 Renderer、页面和真实宿主验收尚未完成。真实新手 E4 样本与微信/抖音目标设备 E3 尚未完成。决策见 [ADR-005](../decisions/005-arena-lightweight-physics.md)、[ADR-006](../decisions/006-arena-local-tick-utility-bot.md)、[ADR-007](../decisions/007-arena-rule-core-governance.md)、[ADR-008](../decisions/008-arena-map-authority-timeline.md)、[ADR-009](../decisions/009-arena-semantic-input-and-movement-authority.md)、[ADR-010](../decisions/010-arena-semantic-presentation-and-assets.md)、[ADR-011](../decisions/011-arena-versioned-local-progression.md)、[ADR-013](../decisions/013-arena-pilot-local-evidence-workspace.md)、[ADR-014](../decisions/014-arena-versioned-device-acceptance-evidence.md)、[ADR-015](../decisions/015-arena-headless-product-session-lifecycle.md)、[ADR-016](../decisions/016-arena-local-match-reward-transaction.md)、[ADR-017](../decisions/017-arena-frozen-symmetric-match-content.md) 和 [ADR-018](../decisions/018-arena-product-presentation-contracts.md)。

本文同时记录已落地边界与后续目标；未明确标记为已落地的模块仍不是当前能力。Stage 6、Stage 7 S7.1、Stage 8 S8.1～S8.4 与 S8.5.1～S8.5.3 处于执行中，Stage 7 S7.2～S7.5、Stage 8 剩余正式 Renderer/三端验收和 Stage 9 仍是提议，分别见 [Stage 6](arena-stage6-input-movement-plan.md)、[Stage 7](arena-stage7-presentation-plan.md)、[Stage 8](arena-stage8-product-progression-plan.md)、[Stage 9](arena-stage9-convergence-plan.md) 执行计划，以及 [Stage 4～9 项目方决策门](arena-stage4-9-decision-gates.md)。当前 v3 架构仍见 [`../architecture.md`](../architecture.md)。
