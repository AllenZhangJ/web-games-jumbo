...
1. 将读招反制和绕后的边缘 Replay 扩展到攻击/跳跃互相穿插、侧向进入和多次转身。
...
本轮已经完成“直线压制、读招反制、绕后的研究动作状态、候选 Replay、双人边缘后果和研究反馈来源收敛”，没有完成“六把武器生产化”。三个研究候选现在为 4/5，仅剩正式 Definition；生产基线仍缺候选专属 Replay。下一步继续做攻击/跳跃穿插、最终表现资产和真人可读性，不扩张角色、按键、界面或收藏系统。
