...
> **项目状态：** Web、微信、抖音默认入口已切换到 Arena V1 Stage 6 灰盒：独立轻量物理、1v1 MatchCore、隐藏本地机器人、三件装备、地图时间轴、语义移动/触控、程序化角色、HUD、结算与重赛已经连成可玩闭环。Stage 8 S8.1～S8.4 的无 UI 产品基础与 S8.5.1～S8.5.3 的产品 ViewModel/Intent/Flow/Session 也已落地；正式 Product Renderer 尚未接入默认入口。当前已通过 Web 真实浏览器、100 局旧表现 Session soak 和 100 局 Product Presentation Session soak；微信/抖音开发者工具、目标真机 E3、A/B 新手盲测和 S8.5 三端正式产品 UI 仍未完成。数值跳台 v3 代码与资产继续保留，两条领域代码保持隔离。
