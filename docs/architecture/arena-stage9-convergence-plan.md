...
提议，2026-07-17。Stage 9 不靠单次手感调参完成，而是把配置候选、固定实验、回放回归、长稳和目标设备证据连接成可复现的冻结流程。Stage 6 已提供通用的版本化设备 Definition/Record/Bundle/Report 与附件完整性验证边界；Stage 9 仍需新增性能指标 Definition，精确设备和预算仍需在真机门禁前由项目方确认。
