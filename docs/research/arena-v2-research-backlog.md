...
- [ ] 将三个 research-only Definition 接入正式 Presentation 反馈事件、声音/特效和生产迁移证据，再评估是否具备生产迁移条件；三个候选均已有研究边界 Replay，正式反馈和生产迁移仍未完成。
