...
import { runArenaV2WeaponMammothStoneAxeReplayPrototype } from '../src/index.js';

describe('Arena V2 mammoth stone axe Replay prototype', () => {
  it('verifies delayed heavy hit, route escape and support-surface consequence', () => {
    const result = runArenaV2WeaponMammothStoneAxeReplayPrototype();
  ...
  it('is deterministic and keeps replay samples frozen', () => {
    const first = runArenaV2WeaponMammothStoneAxeReplayPrototype();
    const second = runArenaV2WeaponMammothStoneAxeReplayPrototype();
