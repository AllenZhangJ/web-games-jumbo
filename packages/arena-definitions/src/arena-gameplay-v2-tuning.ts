...
export const ARENA_GAMEPLAY_V2_TUNING = deepFreeze({
  ...
  attacks: {
    ...
    'line-suppressor-ground': attack({
      targeting: {
        kind: 'facing-capsule',
        range: 6.4,
        radius: 0.42,
        maximumVerticalDifference: 1.25,
      },
      windupTicks: 7,
      activeTicks: 3,
      recoveryTicks: 10,
      cooldownTicks: 24,
      targetGroundKnockbackDistance: 0.5357142857142857,
      verticalImpulse: 2.2,
      hitstunTicks: 12,
    }),
    'line-suppressor-aerial': attack({
      targeting: {
        kind: 'facing-capsule',
        range: 5.2,
        radius: 0.48,
        maximumVerticalDifference: 1.8,
      },
      windupTicks: 6,
      activeTicks: 3,
      recoveryTicks: 14,
      cooldownTicks: 30,
      targetGroundKnockbackDistance: 0.47619047619047616,
      verticalImpulse: 2.8,
      hitstunTicks: 13,
    }),
    'read-counter-ground': attack({
      targeting: {
        kind: 'facing-cone',
        range: 1.65,
        minimumFacingDot: 0.48,
        maximumVerticalDifference: 1.5,
      },
      windupTicks: 18,
      activeTicks: 4,
    ...
    'read-counter-aerial': attack({
      ...
      recoveryTicks: 22,
      cooldownTicks: 72,
      targetGroundKnockbackDistance: 2.5595238095238093,
      verticalImpulse: 7.2,
      hitstunTicks: 30,
    }),
    'flank-blade-ground': attack({
      targeting: {
        kind: 'rear-cone',
        range: 1.9,
        minimumFacingDot: 0.45,
        maximumVerticalDifference: 1.5,
      },
      windupTicks: 6,
      activeTicks: 4,
      recoveryTicks: 14,
      cooldownTicks: 36,
      targetGroundKnockbackDistance: 1.4880952380952381,
      verticalImpulse: 4.2,
      hitstunTicks: 20,
    }),
    'flank-blade-aerial': attack({
      targeting: {
        kind: 'rear-cone',
        range: 2.15,
        minimumFacingDot: 0.35,
        maximumVerticalDifference: 2.2,
      },
      windupTicks: 5,
      activeTicks: 5,
      recoveryTicks: 17,
      cooldownTicks: 42,
      targetGroundKnockbackDistance: 1.7261904761904763,
      verticalImpulse: 4.8,
      hitstunTicks: 22,
    }),
  },
