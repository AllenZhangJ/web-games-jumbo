...
S6.1 的 Character/Input/Replay V4 合同和 S6.2 的 Movement Rule/Core 已提交。S6.3 候选已让 Bot 仅通过公开 MovementSnapshot/ActionAffordance 发出同版 InputFrame，并通过 900 局三档移动与回放门禁。S6.4～S6.6 尚未实现；A/B Mapper 胜者仍未冻结。
