...
已接受整体边界；阶段 1 已选择项目内轻量街机物理，阶段 2 已落地无渲染 MatchCore，阶段 3 已落地隐藏机器人与本地快速匹配，阶段 4 已落地数据驱动 Rule/Core 装备闭环，阶段 5 已落地独立地图权威时间轴。Stage 6 当前已落地 Character/Input/Replay、Movement Rule/Core、Bot 同权移动、三端 Pointer、程序化灰盒、HUD 与 Session/重赛闭环；Web 运行与 100 局 soak 已通过。S6.6.1～S6.6.3a 已建立版本化盲测合同、确定性分组、采集运行时和双槽持久化基础，但 Trial Controller、独立采集入口、真实新手样本与微信/抖音 E3 尚未完成。决策见 [ADR-005](../decisions/005-arena-lightweight-physics.md)、[ADR-006](../decisions/006-arena-local-tick-utility-bot.md)、[ADR-007](../decisions/007-arena-rule-core-governance.md)、[ADR-008](../decisions/008-arena-map-authority-timeline.md)、[ADR-009](../decisions/009-arena-semantic-input-and-movement-authority.md) 和 [ADR-013](../decisions/013-arena-pilot-local-evidence-workspace.md)。
