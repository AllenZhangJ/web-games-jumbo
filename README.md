...
- 在有限步数内让当前值精确等于目标值。
- 顶部内容菜单可组合 5 个玩法、5 个任务、10 个角色，并选择高/低画质；画质不改变游戏结果。
...
- 动作存档在首个起跳表现帧后调度，Hide/PageHide/Destroy 强制刷新，不阻塞松手关键路径。
...
- [高低画质配置](docs/render-quality.md)
- [渲染性能专项状态](docs/governance/render-performance/status.md)
...
- [ADR-006：渲染性能模块化单体与资源预算](docs/decisions/006-render-performance-modular-monolith.md)
- [ADR-007：用户可选高低画质](docs/decisions/007-user-selectable-render-quality.md)
- [ADR-008：首帧后存档调度](docs/decisions/008-post-render-save-scheduler.md)
