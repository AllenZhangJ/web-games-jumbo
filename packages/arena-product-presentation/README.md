...
该 strict TypeScript workspace 承接 Product 的宿主无关表现编排。当前公开能力包括 UI/Gameplay 输入路由、UI 意图串行化、内容/屏幕 Definition、只读 Registry、本地消息目录、Arena V1 静态内容工厂、只读 ViewModel 与单局表现桥；后续按依赖方向继续承接 Product Presentation Flow。
