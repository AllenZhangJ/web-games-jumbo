...
- 状态：已接受；S9.1～S9.3 已实施，S9.4a/S9.5a 工程基础已实施，真实设备与真人证据待执行
- 日期：2026-07-17
...
S9.3b 将“调参”和“验证”拆成隔离 cohort：第一轮只比较 9/11/13 条命，60 paired exploration seed 与历史 baseline、后续 300 paired validation seed 无交集；Selection 使用版本化固定罚分从三份完整 Report 重建，不能由人工或 CLI 覆盖。具体取舍见 [ADR-023](023-arena-isolated-balance-exploration.md)。
